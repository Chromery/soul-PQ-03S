...
import { PropertiesController, PropertyValuationGroupsController } from "./properties.controller.js";
import { PropertiesService } from "./properties.service.js";

@Module({
  imports: [VisuraExtractionModule],
  controllers: [PropertiesController, PropertyValuationGroupsController],
